...
if (isset($_GET['approve_id'])) {
    ...
    $sql_insert = "INSERT INTO certificates (certificate_id,user_id, first_name, middle_name, last_name, dob, gender, place_of_birth, father_name, mother_name, current_address) 
