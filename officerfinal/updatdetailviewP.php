...
<body>
    <div class="container-fluid py-4">
        <div class="row">
            ...
            <div class="col-lg-6">
                <!-- Redesigned Application Details Card -->
                <div class="card mb-4">
                    <div class="card-header">
                        <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#applicationDetailsCollapse" aria-expanded="false" aria-controls="applicationDetailsCollapse">
                            View Application Details
                        </button>
                    </div>
                    <div class="collapse" id="applicationDetailsCollapse">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="detail-row mb-3">
                                        <span class="fw-bold text-primary">Application ID:</span>
                                        <span><?php echo $application["id"] ?></span>
                                    </div>
                                    <div class="detail-row mb-3">
                                        <span class="fw-bold text-primary">Date Submitted:</span>
                                        <span><?php echo $application["submission_date"] ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="detail-row mb-3">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="detail-row mb-3">
                                        <span class="fw-bold text-primary">Applicant Name:</span>
                                        <span><?php echo $application["first_name"] . " " . $application["middle_name"] . " " . $application["last_name"] ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="detail-row mb-3">
                                        <span class="fw-bold text-primary">Contact Email:</span>
                                        <span><?php echo $application["email"] ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="detail-row mb-3">
                                        <span class="fw-bold text-primary">Contact Phone:</span>
                                        <span><?php echo $application["phone"] ?? 'N/A' ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div id="regectpopup" class="regectpopuphidden">
        <div class="containerregect">
            <div class="regect_reason">
                ...
                <h1>Write the reason for rejection</h1>
            </div>
