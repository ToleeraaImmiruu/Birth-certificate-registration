...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 25px rgba(13, 146, 79, 0.4);
        }
        ...
        .hero {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4)), url('https://www.ena.et/documents/d/eng/jima2-jpg') no-repeat center center/cover;
            color: white;
        ...
        #servicesCarousel .carousel-item-right,
        #servicesCarousel .carousel-item-left {
            transform: translateX(0);
        }
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="language-switcher ms-lg-3">
                    <div class="btn-group" role="group" aria-label="Language switcher">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary">OM</button>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="hero-buttons mt-4" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <a href="sign-up.php" class="btn btn-outline-primary"><i class="bi bi-person-plus me-1"></i> Register Now</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="carousel-item active">
                        <div class="row g-4">
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                                <div class="service-card card-hover-grow service-slide">
                                    ...
                                    <div class="service-img">
                                        <img src="https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80" alt="New Birth Registration" class="img-fluid" loading="lazy">
                                    </div>
                            ...
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                                <div class="service-card card-hover-grow service-slide">
                                    <div class="service-img">
                                        <img src="https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1913&q=80" alt="Birth Certificate Reprint" class="img-fluid" loading="lazy">
                                    </div>
                                    <div class="service-content">
                                        <div class="service-icon">
                            ...
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
                                <div class="service-card card-hover-grow service-slide">
                                    ...
                                    <div class="service-img">
                                        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="Online Application Submission" class="img-fluid" loading="lazy">
                                    </div>
                                    <div class="service-content">
                                        <div class="service-icon">
                    ...
                    <div class="carousel-item">
                        <div class="row g-4">
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                                <div class="service-card card-hover-grow service-slide">
                                    <div class="service-img">
                                        <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="E-Certificate" class="img-fluid" loading="lazy">
                                    </div>
                                    <div class="service-content">
                                        <div class="service-icon">
                            ...
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                                <div class="service-card card-hover-grow service-slide">
                                    <div class="service-badge">Popular</div>
                                    <div class="service-img">
                                        <img src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="Certificate Verification" class="img-fluid" loading="lazy">
                                    </div>
                                    <div class="service-content">
                                        <div class="service-icon">
                            ...
                            <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
                                <div class="service-card card-hover-grow service-slide">
                                    <div class="service-img">
                                        <img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80" alt="Community Support" class="img-fluid" loading="lazy">
                                    </div>
                                    <div class="service-content">
                                        <div class="service-icon">
...
<!-- 
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="announcement-card zoom-in">
                        ...
                        <div class="announcement-content">
                            ...
                            <p>Starting November 10th, our office will implement new operating hours from 8:30 AM to 4:30 PM, Monday to Friday.</p>
                            <a href="announcements/new-service-hours.html" class="btn btn-sm btn-outline-primary mt-2">Read Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="announcement-card zoom-in">
                        ...
                        <div class="announcement-content">
                            <h3 class="announcement-title">Holiday Schedule Announcement</h3>
                            <p>Our office will be closed from December 25th to January 1st for the holiday season. Online services will remain available.</p>
                            <a href="announcements/holiday-schedule-2023.html" class="btn btn-sm btn-outline-primary mt-2">Read Details</a>
                        </div>
                    </div>
                </div>
            </div> -->
