...
<body>
  <div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="form-container w-100" style="max-width: 500px;">
      ...
      <form id="hospitalForm">
        ...
        <div class="mb-3">
          <label for="phone" class="form-label"><i class="bi bi-envelope"></i> phone number</label>
  ...
  <script>
    ...
    function showToast(message, type) {
      ...
      setTimeout(() => {
        const toastInstance = bootstrap.Toast.getOrCreateInstance(document.getElementById(toastId));
        toastInstance.hide();
      }, 3000);
    }
  </script>
