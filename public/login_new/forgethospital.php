...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST)) {
    ...
    if ($hospital["email"]) {
        ...
        if ($stmt->execute()) {
            ...
            $notify = "INSERT INTO messages (hospital_id, title, body) VALUES (?,?,?)";
            ...
            $stmt->bind_param("iss", $hospital['id'], $title, $msg);
            $stmt->execute();
...
<body>
    <div class="login-container">
        ...
        <form action="forgethospital.php" method="POST">
            <div class="mb-4">
                <label for="email" class="form-label">Email Address</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                    <input type="email" class="form-control" id="email" name="email" placeholder="ifaabulaa@gmail.com" required>
                </div>
            </div>
